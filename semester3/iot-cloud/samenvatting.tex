...
\subsubsection{Oude manier van applicatiedeploment}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Toegang tot GPU vanuit Docker enkel op Linux
    \end{itemize}
    ...
    \item PC/MAC/Linux omgevingen in 1 team
    \item Deployment op Raspberry Pi
    \item \dots zoals er maar een Docker Engine aanwezig is
\end{itemize}
...
\begin{itemize}
    ...
    \item Docker Community Edition: \url{https://store.docker.com/editions/community/docker-ce-desktop-windows}
\end{itemize}
...
\begin{itemize}
    ...
    \item Via een Docker file kunnen we een Docker image aanmaken
...
\begin{figure}[H]
    ...
    \caption{Offici"ele repositories voor Dockerfiles}
\end{figure}
...
\begin{itemize}
    ...
    \item Wat met data?
    \begin{itemize}
        \item Externe services gebruiken:
