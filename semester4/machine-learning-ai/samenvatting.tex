...
\begin{itemize}
    \item \url{https://scikit-learn.org/stable/modules/model_evaluation.html#the-scoring-parameter-defining-model-evaluation-rules}
\end{itemize}

\subsubsection{Class-weight balancing}

Misclassificatie van samples uit de minderheidsklasse leiden tijdens training tot een hogere loss.
