...
\begin{figure}[H]
    ...
    \caption{Overzicht. Meer info: \url{http://www.asimovinstitute.org/neural-network-zoo/}}
\end{figure}

\begin{itemize}
    \item Het is mogelijk om met neuronen verschillende types netwerken te maken
    \item TODO
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{neural-net-xor.png}
    \caption{XOR-functie}
\end{figure}

\begin{itemize}
    \item Men had lang geleden al door TODO
\end{itemize}
...
\section{Aan de slag met Tensorflow en Keras}
