CREATE DATABASE  IF NOT EXISTS `mendeljev` /*!40100 DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mendeljev`;
-- MySQL dump 10.13  Distrib 8.0.19, for Win64 (x86_64)
--
-- Host: localhost    Database: mendeljev
-- ------------------------------------------------------
...
CREATE TABLE `elements` (
  ...
  `yearDiscovered` int DEFAULT NULL,
  `displayRow` int DEFAULT NULL,
  `displayColumn` int DEFAULT NULL,
...
-- Dump completed on 2020-05-05 10:51:09
